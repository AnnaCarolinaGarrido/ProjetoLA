...
Todo o processo inicia-se no carregamento do arquivo de entrada, no qual são inputadas as regras de transição que formam a gramática a ser validada pelo LBA. O número inicial de regras é lido e um looping é aplicado para a leitura de todas as regras.
