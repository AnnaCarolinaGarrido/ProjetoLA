...
*Nota: Todos os estados que representam casas do tabuleiro são definidos como estados de aceitação ($F$), incluindo o estado inicial ($q_{0}$). O único estado de não-aceitação é o ($q_{err}$)
